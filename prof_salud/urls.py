...
urlpatterns = [ 
    ...
    path('resultados_laboratorio/', views.resultados_lab, name='resultados_lab'),
    path('resultados_laboratorio/ver-pdf/<int:resultado_id>/', views.ver_resultado_lab_pdf, name='ver_resultado_lab_pdf'),
    path('resultados_laboratorio/generar-pdf/<int:resultado_id>/', views.generar_resultado_lab_pdf, name='generar_resultado_lab_pdf'),
